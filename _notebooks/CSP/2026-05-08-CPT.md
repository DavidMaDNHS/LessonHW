...
<details style="padding: 15px; border-radius: 8px; margin-bottom: 20px; border-left: 4px solid #007bff;">
  ...
  <div style="margin-top: 10px;">
    <p>This draft tool helps you improve your CPT Project by providing AI-powered feedback on different aspects of your text.</p>

    <h4>Analysis Modes:</h4>
    <ul>
      <li><strong>CPT Check:</strong> Identifies requirements and suggests proper corrections</li>
      <li><strong>Idea check:</strong> Evaluates project idea</li>
      <li><strong>Requirement Check:</strong> Checks project requiremnts</li>
      <li><strong>FRQ Help:</strong> Assists on questions that will be asked on the AP Exam</li>
    </ul>
    
    <p><em>Note: Sample Projects are provided for each mode to help you explore different types of feedback. You can replace them with your own code and explanations.</em></p>
  </div>
</details>
...
<div class="controls">
    <div class="control-group">
        <select id="analysisMode">
            <option value="plagiarism">CPT Check</option>
            <option value="thesis">Idea Check</option>
            <option value="five-paragraph">Requirement Check</option>
            <option value="research">FRQ Help</option>
        </select>
    </div>
    <div class="control-group">
